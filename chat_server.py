...
# ==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]
                message = msg["message"]
                full_msg = msg["from"] + " " + message
                the_guys = self.group.list_me(from_name)
                for g in the_guys:
                    self.indices[g].add_msg_and_index(full_msg)
                ...
                mysend(from_sock, json.dumps(
                    {
                        "action": "list",
                        "results": msg,
                        "users": sorted(self.group.members.keys()),
                        "groups": self.group.chat_grps,
                    }
                ))
# ==============================================================================
